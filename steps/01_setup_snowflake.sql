...
CREATE OR REPLACE API INTEGRATION git_api_integration
  ...
  API_ALLOWED_PREFIXES = ('https://github.com/peterjohnbeck') -- INSERT YOUR GITHUB USERNAME HERE
  ENABLED = TRUE;
...
CREATE OR REPLACE GIT REPOSITORY quickstart_common.public.quickstart_repo
  ...
  ORIGIN = 'https://github.com/peterjohnbeck/sfguide-getting-started-with-snowflake-devops'; -- INSERT URL OF FORKED REPO HERE
